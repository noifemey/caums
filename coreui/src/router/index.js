...
//const AllContainer = () => import('@/containers/Container')
const ThePageContainer = () => import('@/containers/pagecontainers/ThePageContainer')
...
const Allocations = () => import('@/views/allocations/Allocations')
const PAPCodes = () => import('@/views/papcodes/PAPCodes')
const AccountCodes = () => import('@/views/accountcodes/AccountCodes')
const AllocationSummary = () => import('@/views/reports/AllocationSummary')
const AllocationStatus = () => import('@/views/reports/AllocationStatus')
const RCI = () => import('@/views/reports/RCI')
const CDR = () => import('@/views/reports/CDR')
const PAP = () => import('@/views/reports/PAP')
const PAPStatement = () => import('@/views/reports/PAPStatement')
const Vouchers = () => import('@/views/vouchers/Vouchers')
const Transactions = () => import('@/views/vouchers/Transactions')
