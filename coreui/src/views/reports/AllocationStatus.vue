<template>
  <CRow>
    <CCol col="12" xl="12">
      ...
      <CCard>
        <CCardHeader>
             <h4>Status of Cash Allocations, Utilized and Balances </h4>
        </CCardHeader>
        <CCardBody>
          ...
          <div class="row">
            ...
            <div class="col-2">
              <label></label>
              <button type="button" class="btn btn-primary btn-lg btn-block" @click = "exportStatus"> Export </button>
            </div>
          </div>
          </form>
